...
namespace SistemaControle.Controllers.MVC
{
    ...
    public class GruposController : Controller
    {
        ...
        public ActionResult AddEstudante(int? id)
        {
            ...
            GruposDetalhes gruposDetalhes = new GruposDetalhes
            {
                GrupoId = id.Value
            };
        ...
        public ActionResult AddEstudante(GruposDetalhes gruposDetalhes)
        {
            ...
            ViewBag.UserId = new SelectList(db.Usuarios.Where(u => u.Professor).OrderBy(u => u.Nome).ThenBy(u => u.Sobrenome), "UserId", "NomeCompleto", gruposDetalhes.UserId);
